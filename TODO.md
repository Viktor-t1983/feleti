...
- [x] ✅ Партии (список, детали, управление)
- [x] ✅ Продукты (список, детали, поиск по slug)
...
> **Приоритет:** Редактор рецептов → Тестирование → Реальный стенд.
> Streaming AI готов (SSE, кнопка Stop, sources).

1. **Сессия 14 (Редактор рецептов):** CRUD + конструктор фаз
2. **Сессия 15 (тестирование):** pytest + интеграционные тесты
3. **Сессия 16 (реальный стенд):** FELETI-SMOK driver + Kinco PLC
