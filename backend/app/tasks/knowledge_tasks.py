...
DEFAULT_COLLECT_QUERIES = [
    "site:ijiza.ru копчение рыбы оборудование технология рецепт",
    "site:varmen.pro термокамера копчение промышленная технология",
    "site:vniro.ru технология переработки рыбы копчение ГОСТ",
    "site:vniimp.ru мясопереработка копчение колбаса технологическая инструкция",
    "site:smokehouse.ru промышленное копчение оборудование рецептуры",
]
